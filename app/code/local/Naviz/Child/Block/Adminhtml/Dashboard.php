...
class Naviz_Child_Block_Adminhtml_Dashboard extends Mage_Adminhtml_Block_Dashboard
{
    protected $_locale;
    ...
    protected function _prepareLayout()
    {
         $this->setChild('lastOrders',
                $this->getLayout()->createBlock('adminhtml/dashboard_orders_grids')
        );
		
		 $this->setChild('pendingOrders',
                $this->getLayout()->createBlock('adminhtml/dashboard_orders_pending')
        );
		
		 $this->setChild('completedOrders',
                $this->getLayout()->createBlock('adminhtml/dashboard_orders_completed')
        );
