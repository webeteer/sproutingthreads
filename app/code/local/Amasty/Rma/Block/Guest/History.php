...
class Amasty_Rma_Block_Guest_History extends Mage_Core_Block_Template
{
    ...
    public function setCollection($mode, $updatePager = TRUE){
		...
		$tableName = $resource->getTableName('amasty_amrma_request'); 
		$query = "UPDATE {$tableName} SET status_id = 6 WHERE timestampdiff(DAY,created, now())>=15";
    ...
    public function getAvailableOrders()
    {
	 ...
	 public function getSelfCheckoutOrders()
    {
        $ret = array();
